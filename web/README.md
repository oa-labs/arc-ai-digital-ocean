# ArcAI Ocean Web Application

A modern, secure file management web application for S3-compatible object storage (DigitalOcean Spaces) with Supabase authentication. Part of the ArcAI Ocean ecosystem for workplace safety AI assistance.
...
This web application is part of the ArcAI Ocean ecosystem. For more information about the overall project:
